...
JNIEXPORT jint JNICALL Java_org_fengwx_gif_GifDrawable_openFile(JNIEnv * env,
...
JNIEXPORT jint JNICALL Java_org_fengwx_gif_GifDrawable_openStream(JNIEnv * env,
...
JNIEXPORT jint JNICALL Java_org_fengwx_gif_GifDrawable_openFd(JNIEnv * env,
...
JNIEXPORT jint JNICALL Java_org_fengwx_gif_GifDrawable_renderFrame(
...
JNIEXPORT void JNICALL Java_org_fengwx_gif_GifDrawable_free(JNIEnv * env,
...
JNIEXPORT jstring JNICALL Java_org_fengwx_gif_GifDrawable_getComment(
...
JNIEXPORT jint JNICALL Java_org_fengwx_gif_GifDrawable_getLoopCount(
		JNIEnv * env, jobject obj, jobject gifInfo) {
	if (gifInfo == NULL)
		return 0;
